...
def runCD(datafile):
    ...
    for c in columns:
        ...
        causes, causeswithdelay, realloss, scores = causalDiscovery.findcauses(c, cuda=cuda, epochs=nrepochs, 
...
def main(datafiles, evaluation):
    ...
    for datafile in datafiles.keys(): 
        ...
        # run TCDF
        allcauses, alldelays, allreallosses, allscores, columns= runCD(datafile) #results of TCDF containing indices of causes and effects

        print("\n===================Results for", stringdatafile,"==================================")
        columns.append('trueCause')
        for pair in alldelays:
            print(pair[1])
...
parser = argparse.ArgumentParser(description='Causal Discovery: CD')
...
#$ $ /bin/python3 "/home/WVU-AD/lay0005/Documents/VSCode Files/runCD.py" --data demo_dataset.csv   
# WITH GROUNDTRUTH
# /bin/python3 "/home/WVU-AD/lay0005/Documents/VSCode Files/runCD.py" --ground_truth demo_dataset.csv=demo_groundtruth.csv