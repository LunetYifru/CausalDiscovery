...
class KMeans: 
        ...
        for i in range(k):
            ...
            for j in range(0,len(data)):
                if cluster_assignment[j] == i:
                    members.append(j)
            for k in members:
                member_data_points = data.iloc[members,:]
            ...
            if member_data_points.shape[0] > 0: # check if i-th cluster is non-empty
                ...
                # Avoiding Singular Matrix issue with mahalanobis distance
    ...
    def assign_clusters(self,data, centroids, distance):
        ...
        distances_from_centroids = pairwise_distances(data, centroids, metric=distance, **kwds)
    ...
    def get_initial_centroids(self, data, k, seed=None):
        ...
        centroids = data.iloc[rand_indices,:]
